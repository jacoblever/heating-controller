# Heating Controller Dashboard

Displays current state of the system. This project was bootstrapped with [Create React App](https://github.com/facebook/create-react-app) and deploys to a static website served using python.
